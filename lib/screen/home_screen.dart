...
import 'package:tab_bar/screen/bottom_navigation_bar5.dart';
import 'package:tab_bar/screen/on_boarding_screen.dart';
import 'package:tab_bar/screen/on_boarding_screen2.dart';
          ...
          children: [
            Column(
              ...
              children: [
                ...
                ElevatedButton(onPressed: () {
                  Navigator.of(context).push(MaterialPageRoute(builder: (context) => BottomNavigationBar5(),));
                }, child: Text("BottomNavigation Bar 5 Screen")),
                ElevatedButton(onPressed: () {
                  Navigator.of(context).push(MaterialPageRoute(builder: (context) => OnBoardingScreen2(),));
                }, child: Text("OnBoarding 2 Screen")),
              ],
            ),
          ],
        ),
